import {
  to = segment_user.id-8WJRAaVNhgaSSZWn75336S
  id = "8WJRAaVNhgaSSZWn75336S"
}

resource "segment_user" "id-8WJRAaVNhgaSSZWn75336S" {
  email = "alexander.rotteveel@drivetime.com"
  permissions = [
    {
      resources = [
        {
