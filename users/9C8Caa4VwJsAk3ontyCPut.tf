import {
  to = segment_user.id-9C8Caa4VwJsAk3ontyCPut
  id = "9C8Caa4VwJsAk3ontyCPut"
}

resource "segment_user" "id-9C8Caa4VwJsAk3ontyCPut" {
  email = "venuniranjanchowdary.machavarapu@drivetime.com"
  permissions = [
    {
      resources = [
        {
          id = "tJXJx41ERuqHR7rejkf5ZZ"
          labels = [
          ]
          type = "WORKSPACE"
        },
