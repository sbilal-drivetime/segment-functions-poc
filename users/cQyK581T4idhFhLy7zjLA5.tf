import {
  to = segment_user.id-cQyK581T4idhFhLy7zjLA5
  id = "cQyK581T4idhFhLy7zjLA5"
}

resource "segment_user" "id-cQyK581T4idhFhLy7zjLA5" {
  email = "andrew.carlson@silverrockinc.com"
  permissions = [
    {
      resources = [
        {
