import {
  to = segment_user.id-dREdx5TaKF22WgqbtJURHv
  id = "dREdx5TaKF22WgqbtJURHv"
}

resource "segment_user" "id-dREdx5TaKF22WgqbtJURHv" {
  email = "suryanandsagar.kukkala@drivetime.com"
  permissions = [
    {
      resources = [
        {
