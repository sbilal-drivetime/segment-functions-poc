import {
  to = segment_user.id-dmwPJ5qxp9UoKP8KH1e1qR
  id = "dmwPJ5qxp9UoKP8KH1e1qR"
}

resource "segment_user" "id-dmwPJ5qxp9UoKP8KH1e1qR" {
  email = "jonathan.oberhaus@drivetime.com"
  permissions = [
    {
      resources = [
        {
