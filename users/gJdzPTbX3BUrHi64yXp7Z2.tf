import {
  to = segment_user.id-gJdzPTbX3BUrHi64yXp7Z2
  id = "gJdzPTbX3BUrHi64yXp7Z2"
}

resource "segment_user" "id-gJdzPTbX3BUrHi64yXp7Z2" {
  email = "aparna.yellapragada@bridgecrest.com"
  permissions = [
    {
      resources = [
        {
