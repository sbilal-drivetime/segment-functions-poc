import {
  to = segment_user.id-jRLagxKQ1tX3r7BukddM9W
  id = "jRLagxKQ1tX3r7BukddM9W"
}

resource "segment_user" "id-jRLagxKQ1tX3r7BukddM9W" {
  email = "shilpa.reddymekapothula@drivetime.com"
  permissions = [
    {
      resources = [
        {
