import {
  to = segment_user.id-jjSuvHwiNCmQuYrGc4cC2g
  id = "jjSuvHwiNCmQuYrGc4cC2g"
}

resource "segment_user" "id-jjSuvHwiNCmQuYrGc4cC2g" {
  email = "johnathan.townsley@drivetime.com"
  permissions = [
    {
      resources = [
        {
