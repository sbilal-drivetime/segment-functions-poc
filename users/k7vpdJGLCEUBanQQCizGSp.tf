import {
  to = segment_user.id-k7vpdJGLCEUBanQQCizGSp
  id = "k7vpdJGLCEUBanQQCizGSp"
}

resource "segment_user" "id-k7vpdJGLCEUBanQQCizGSp" {
  email = "yokeshwaran.lokanathan@drivetime.com"
  permissions = [
    {
      resources = [
        {
