import {
  to = segment_user.id-nH3opiCRkRUAaED9Xdc7NZ
  id = "nH3opiCRkRUAaED9Xdc7NZ"
}

resource "segment_user" "id-nH3opiCRkRUAaED9Xdc7NZ" {
  email = "david.oesterreich@bridgecrest.com"
  permissions = [
    {
      resources = [
        {
