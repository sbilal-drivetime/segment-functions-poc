import {
  to = segment_user.id-rsCLLJxovdphR2HhuzGdUh
  id = "rsCLLJxovdphR2HhuzGdUh"
}

resource "segment_user" "id-rsCLLJxovdphR2HhuzGdUh" {
  email = "jonathan.little@bridgecrest.com"
  permissions = [
    {
      resources = [
        {
