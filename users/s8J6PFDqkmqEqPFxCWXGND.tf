import {
  to = segment_user.id-s8J6PFDqkmqEqPFxCWXGND
  id = "s8J6PFDqkmqEqPFxCWXGND"
}

resource "segment_user" "id-s8J6PFDqkmqEqPFxCWXGND" {
  email = "vijayadithya.doddi@drivetime.com"
  permissions = [
    {
      resources = [
        {
