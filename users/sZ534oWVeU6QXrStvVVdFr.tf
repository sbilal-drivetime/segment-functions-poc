import {
  to = segment_user.id-sZ534oWVeU6QXrStvVVdFr
  id = "sZ534oWVeU6QXrStvVVdFr"
}

resource "segment_user" "id-sZ534oWVeU6QXrStvVVdFr" {
  email = "nagabhavya.amaravadi@drivetime.com"
  permissions = [
    {
      resources = [
        {
