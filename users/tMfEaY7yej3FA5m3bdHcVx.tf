import {
  to = segment_user.id-tMfEaY7yej3FA5m3bdHcVx
  id = "tMfEaY7yej3FA5m3bdHcVx"
}

resource "segment_user" "id-tMfEaY7yej3FA5m3bdHcVx" {
  email = "michael.burroughs@drivetime.com"
  permissions = [
    {
      resources = [
        {
